                          ...
                          {isAdmin && (
                            <td>
                              <div className="flex gap-1">
                                <button type="button" onClick={() => startEdit(p)} className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-600 hover:text-accent" aria-label="Edit"><Pencil className="h-4 w-4" /></button>
